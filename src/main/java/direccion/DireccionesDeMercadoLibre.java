...
public class DireccionesDeMercadoLibre implements DireccionesService{
    ...
    public List<String> getCiudades(String nombreProvincia) throws IOException {
        ...
        String id = MercadoLibreJSONHandler.obtenerIdDeLaProvincia(this.informacionPaisObject, nombreProvincia);
        ...
        List<String> ciudades = MercadoLibreJSONHandler.obtenerListaDeCiudadesDesdeJSONObject(ciudadesObject);
        return ciudades;
    }
    ...
    public List<String> getProvinciasDisponibles(String nombrePais) throws IOException {
        ...
        String id = MercadoLibreJSONHandler.obtenerIdDelPais(this.paisesArray, nombrePais);
        ...
        List<String> provincias = MercadoLibreJSONHandler.obtenerListaDeProvinciasDesdeJSONObject(this.informacionPaisObject);
        return provincias;
    }
    ...
    public List<String> getPaisesDisponibles() throws IOException {
        ...
        List<String> paises = MercadoLibreJSONHandler.obtenerListaPaisesDeJSONArray(paisesArray);
        return paises;
    }
